...
! prescribed. if not set allturbpresent to .false.
    allturbpresent = setbcvarturb_d(17_inttype, boco, bcvararray, &
&     bcvararrayd, ibeg, iend, jbeg, jend, bcdata(boco)%turbinlet, &
&     bcdatad(boco)%turbinlet)
!=================================================================

  contains
!  differentiation of totalsubsonicinlet in forward (tangent) mode (with options i4 dr8 r8):
!   variations   of useful results: *(*bcdata.ptinlet)[from module blockpointers]
...
! set the turbulence values
        allturbpresent = setbcvarturb_d(7_inttype, boco, bcvararray, &
&         bcvararrayd, ibeg, iend, jbeg, jend, bcdata(boco)%turbinlet, &
&         bcdatad(boco)%turbinlet)
...
!   variations   of useful results: *(*bcdata.turbinlet)[from module blockpointers]
...
!=================================================================
  logical function setbcvarturb_d(offset, boco, bcvararray, bcvararrayd&
&   , ibeg, iend, jbeg, jend, turbinlet, turbinletd) result (&
& setbcvarturb)
!
