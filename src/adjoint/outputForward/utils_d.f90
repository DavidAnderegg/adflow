...
!   with respect to varying inputs: timeref
  real(kind=realtype) function derivativerigidrotangle_d(degreepolrot, &
&   coefpolrot, degreefourrot, omegafourrot, coscoeffourrot, &
&   sincoeffourrot, t, derivativerigidrotangle)
!
