...
!  differentiation of derivativerigidrotangle in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
!  differentiation of mydim in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
!  differentiation of mynorm2 in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
!  differentiation of cross_prod in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
!   gradient     of useful results: smax g1 g2
!   with respect to varying inputs: smax g1 g2
!   rw status of diff variables: smax:in-zero g1:incr g2:incr
  subroutine smoothmax_b(smax, smaxd, g1, g1d, g2, g2d, phi)
    use constants
    implicit none
...
!   gradient     of useful results: g1 g2 smin
!   with respect to varying inputs: g1 g2 smin
!   rw status of diff variables: g1:incr g2:incr smin:in-zero
  subroutine smoothmin_b(smin, smind, g1, g1d, g2, g2d, phi)
    use constants
    implicit none
