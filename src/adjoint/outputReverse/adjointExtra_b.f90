...
contains
!  differentiation of volume_block in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
&                 , vp1, vp1d)
  ...
  contains
!  differentiation of volpym in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
!  differentiation of metric_block in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
!  differentiation of boundarynormals in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
!  differentiation of xhalo_block in reverse (adjoint) mode (with options noisize i4 dr8 r8):
...
!  differentiation of sumdwandfw in reverse (adjoint) mode (with options noisize i4 dr8 r8):
!   gradient     of useful results: *dw
