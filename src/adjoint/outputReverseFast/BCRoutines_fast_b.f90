...
! apply bc's for a single block
    use constants
    use blockpointers, only : nbocos, bctype, nviscbocos, w, dw, &
&   x, vol, il, jl, kl, sectionid, wold, volold, bcdata, si, sj, sk, &
&   sfacei, sfacej, sfacek, rlv, gamma, p, rev, bmtj1, bmtj2, scratch, &
&   bmtk2, bmtk1, fw, aa, d2wall, bmti1, bmti2, s
...
! condition the pointers already defined.
    ...
    use bcpointers, only : ww0, ww1, ww2, rlv0, rlv1, rlv2, pp0, pp1, &
...
!  bleed outflow.
    use constants
    use blockpointers, only : bcdata
    use bcpointers, only : ww0, ww1, ww2, pp0, pp1, pp2, rlv0, rlv1, &
...
!  correct block on the correct grid level.
    ...
    use bcpointers, only : ww0, ww1, ww2, pp0, pp1, pp2, pp3, rlv0, rlv1&
&   , rlv2, rev0, rev1, rev2, ss, ssi, ssj, ssk, istart, isize, jstart, &
&   jsize, iend, jend
    implicit none
! subroutine arguments.
    logical, intent(in) :: secondhalo, correctfork
...
! the correct block on the correct grid level.
    ...
    use blockpointers, only : bcdata
    use flowvarrefstate, only : eddymodel, viscous
    use bcpointers, only : ww0, ww1, pp0, pp1, rlv0, rlv1, rlv2, rev0, &
...
!use inputphysics
    use bcpointers, only : ww1, ww2, ww3, pp1, pp2, pp3, rlv1, rlv2, &
&   rev1, rev2, istart, jstart, isize, jsize
    implicit none
! subroutine arguments.
    logical, intent(in) :: secondhalo, correctfork
